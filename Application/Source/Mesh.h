...
public:
	...
	static unsigned locationMap_Kd_Enabled;

	static void SetMaterialLoc(unsigned kA, unsigned kD, unsigned kS, unsigned nS, unsigned map_Kd, unsigned Map_Kd_Enabled);
};
