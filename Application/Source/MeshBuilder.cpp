...
Mesh* MeshBuilder::GenerateCube(const std::string &meshName, Color color, float lengthX, float lengthY, float lengthZ)
{
	...
	v.pos.Set(0.5f, 0.5f, 0.5f); v.texCoord.Set(1, 1); vertex_buffer_data.push_back(v); //0
	v.pos.Set(-0.5f, 0.5f, 0.5f);   vertex_buffer_data.push_back(v); //1
	v.pos.Set(-0.5f, -0.5f, 0.5f); vertex_buffer_data.push_back(v); // 2
	v.pos.Set(0.5f, 0.5f, 0.5f);  v.texCoord.Set(1, 1);  vertex_buffer_data.push_back(v); //0
	v.pos.Set(-0.5f, -0.5f, 0.5f); vertex_buffer_data.push_back(v); // 2
	v.pos.Set(0.5f, -0.5f, 0.5f); vertex_buffer_data.push_back(v); // 3

	v.normal.Set(1, 0, 0);
	v.pos.Set(0.5f, 0.5f, -0.5f);  vertex_buffer_data.push_back(v); // 6
	v.pos.Set(0.5f, 0.5f, 0.5f);  vertex_buffer_data.push_back(v); //0
	v.pos.Set(0.5f, -0.5f, 0.5f); vertex_buffer_data.push_back(v); // 3
	v.pos.Set(0.5f, 0.5f, -0.5f);  vertex_buffer_data.push_back(v); // 6
	v.pos.Set(0.5f, -0.5f, 0.5f); vertex_buffer_data.push_back(v); // 3
	v.pos.Set(0.5f, -0.5f, -0.5f);  vertex_buffer_data.push_back(v); // 7

	v.normal.Set(0, 0, -1);
	v.pos.Set(-0.5f, 0.5f, -0.5f);  vertex_buffer_data.push_back(v); // 4
	v.pos.Set(0.5f, 0.5f, -0.5f);  vertex_buffer_data.push_back(v); // 6
	v.pos.Set(0.5f, -0.5f, -0.5f);  vertex_buffer_data.push_back(v); // 7
	v.pos.Set(-0.5f, 0.5f, -0.5f);  vertex_buffer_data.push_back(v); // 4
	v.pos.Set(0.5f, -0.5f, -0.5f);  vertex_buffer_data.push_back(v); // 7
	v.pos.Set(-0.5f, -0.5f, -0.5f);  vertex_buffer_data.push_back(v); // 5
